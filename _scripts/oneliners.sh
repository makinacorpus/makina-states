...
# find *sls cloud services_managers tests projects bootstraps controllers mc_states files localsettings _macros nodetypes services top.sls -type f>locfiles
