...
providers_lxc_salt:
  file.managed:
    ...
    - source: salt://makina-states/files/etc/salt/cloud.providers.d/makinastates_minion.conf
...
profiles_lxc_salt:
  file.managed:
    - template: jinja
    - source: salt://makina-states/files/etc/salt/cloud.profiles.d/makinastates_minion.conf
    - name: {{pfdir}}/makinastates_minion.conf
    - user: root
    - group: root
    - defaults: {{lxcSettings|yaml}}
    - require:
