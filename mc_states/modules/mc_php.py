...
def settings():
    ...
    def _settings():
        ...
        -------- MODULE ZEND OPCACHE --------------------------
        replacement for APC!
        @see https://raw.github.com/zendtech/ZendOptimizerPlus/master/README for details
        of options
        ...
        * lazy_classes :  same as above
        ...
        phpStepThree = __salt__['grains.filter_by']({
            'Debian': {
                ...
                'fpm_sockets_dir': locations['var_lib_dir'] + '/apache2/fastcgi'
            }
          },
          grain='os_family',
          merge=phpStepTwo
        ...
        phpData = __salt__['mc_utils.defaults']('makina-states.services.php', phpStepThree)
