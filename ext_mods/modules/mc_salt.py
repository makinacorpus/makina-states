...
def _settings():
    ...
    saltMinionData = __salt__['mc_utils.dictupdate'](saltCommonData.copy(), {
        ...
        'module_dirs': ['{salt_root}/_modules',
                        '{salt_root}/makina-states/ext_mods/modules'],
        'returner_dirs': ['{salt_root}/_returners',
                          '{salt_root}/makina-states/ext_mods/returners'],
        'grains_dirs': ['{salt_root}/_grains',
                        '{salt_root}/makina-states/ext_mods/grains'],
        'states_dirs': ['{salt_root}/_states',
                        '{salt_root}/makina-states/ext_mods/states'],
        'render_dirs': ['{salt_root}/_renderers',
                        '{salt_root}/makina-states/ext_mods/renderers'],
        'providers': {},
    ...
    saltMasterData = __salt__['mc_utils.dictupdate'](saltCommonData.copy(), {
        ...
        'runner_dirs': ['{salt_root}/_runners',
                        '{salt_root}/makina-states/ext_mods/runners'],
        'file_ignore_glob': [],
    ...
    _DATA['settings'] = locals()


def settings():
    if not _DATA['settings']:
        _settings()
