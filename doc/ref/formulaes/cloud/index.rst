...
- Basically we do:
    ...
    - predeploy
        ...
        - The cloud controller will configure the compute node reverse proxy & firewall

    - deploy

        - The actions for the VM to be spawn and rattached to the cloud controller (mainly executing the cloud.profile state)
